...
- EPUB export now streams chapters, reports throttled chapter-level progress, keeps canonical source ordering, and honors the independent EPUB/ZIP compression settings.
